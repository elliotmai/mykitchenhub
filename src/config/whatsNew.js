...
export const WHATS_NEW = [
  ...
  },
  {
    ...
    items: [
      ...
      '\u{1F4FA} The fridge board has the list on it now, in the corner that used to say \u201cComing soon\u201d. Everything still to buy, big enough to read on your way past with your coat on \u2014 and whatever you ticked off is already gone from it.',
    ],
  },
  {
